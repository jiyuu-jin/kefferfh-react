  ...
  render() {
    return (
      <div className="container">
        ...
        <p> Service at Funeral Home or Church *¹ (includes flannel covered casket): <span className="bold">$3,495.00</span></p>
        <p>Funeral Home charges without casket (caskets $415 & up): <span className="bold">$3,040.00</span></p>


        <h5 className="blue-text">2. Immediate Burial followed by Memorial Service (One Funeral Director):</h5>
        <p>As above with limited family requirements for funeral home staff and no cemetery procession.  Service other than funeral home (No flower or service car)*¹ including flannel covered casket.: <span className="bold">$2,620.00</span>
              Funeral Home charges without casket (caskets $415 & up): - <span className="bold">$2,225.00</span></p>
        ...
        <p>Limited professional service and care of the body, removal from place of death, office  and transportation expense and flannel (Without any attendant rites or ceremonies)
            Immediate Burial including flannel covered casket. (must be paid at or prior to time of need): - <span className="bold">$1,990.00</span>
            Funeral Home charges without casket (caskets $415 & up): - <span className="bold">$1,620.00</span>
        </p>
        ...
        <ul className="disc-list">
          ...
          <li>($6.00 each; $20.00 when ordered from Pennsylvania Vital Records)</li>
