    ...
    return (
      <div className="container">
        ...
        <div className="push-right">
          ...
          <span className="bold">$5,095.00</span>

          <h6>Church Service*</h6>
          <span className="bold">$5,125.00</span>
        ...
        <p>Direct Cremation with Memorial Service:
              Staff for memorial service, register book, memorial folders, acknowledgement cards, office work, cremation casket and crematory charge, use of funeral home and equipment and service of assistants, service vans to cemetery. (Includes a plastic utility urn.) - <span className="bold">$3,290.00</span></p>
        ...
        <p>Direct Cremation with Memorial Service (One Funeral Director):
              ...
              - <span className="bold">$2,680.00</span></p>
        ...
        <ul className="disc-list">
          ...
          <li>Certified copies of the death certificate ($6.00 each), $20 when ordered from Pennsylvania Vital Records .</li>
